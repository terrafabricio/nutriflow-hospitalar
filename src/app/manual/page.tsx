...
export default function ManualPage() {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] bg-[var(--surface)] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                <header className="lg:hidden bg-[var(--surface)] border-b border-[var(--border-subtle)] p-4 flex items-center gap-3 z-20">
                    <button onClick={() => setIsSidebarOpen(true)} className="p-2 bg-[var(--surface2)] rounded text-[var(--text-main)] hover:bg-[var(--border-subtle)] transition-colors"><Menu size={20} /></button>
                    <span className="font-bold text-[var(--text-main)] font-[family-name:var(--font-space)]">Manual HC-UFU</span>
                </header>
